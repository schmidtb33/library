...
INSERT INTO `book` VALUES (1,'The Lord of the Rings','J.R.R. Tolkien'),(2,'The Great Gatsby','F. Scott Fitzgerald'),(3,'Jane Eyre','Charlotte Bronte'),(4,'The Hobbit','J.R.R. Tolkien'),(5,'The Catcher in the Rye','J.D. Salinger'),(6,'To Kill a Mockingbird','Harper Lee'),(7,'Pride and Prejudice','Jane Austin'),(8,'1984','George Orwell');
...
INSERT INTO `user` VALUES (1,'Mr',NULL,'John','Doe','Main street','1','12345','Berlin','A very good guy','2014-06-10 09:37:48');
...
GRANT ALL PRIVILEGES ON books.* TO 'book'@'localhost' IDENTIFIED BY 'book_345345_test' WITH GRANT OPTION;
...
-- Dump completed on 2014-06-10 11:57:04
